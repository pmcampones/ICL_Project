...
import static compiler.Compiler.generateOutputFile;
  ...
  public static void main(String[] args) {
    ...
    while (true) {
        try {
            ...
            exp.compile(cb, new Environment<>());
            generateOutputFile(".", "Demo", cb);
        } catch (Exception e) {
...
{if ("" != null) return new ASTDef(variables, body);}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x600,0x600,0x1800,0x1800,0x2590,0x80,};
	}
